...
namespace ProyectoTest.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult ObtenerCiudad(string _IdDepartamento)
        {
            ...
            oLista = UbigeoLogica.Instancia.ObtenerCiudad(_IdDepartamento);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult ObtenerBarrio(string _IdCiudad,string _IdDepartamento)
        {
            List<Barrio> oLista = new List<Barrio>();
            oLista = UbigeoLogica.Instancia.ObtenerBarrio(_IdCiudad,_IdDepartamento);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }
